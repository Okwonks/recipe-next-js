export default {
  ...
  fields: [
    ...
    { name:'mainImage', title:'Recipe Main Image', type:'image', options:{ hotspot:true }},
    {
      name: 'ingredient',
      title: 'Ingredient',
      type: 'array',
      of: [
        {
          ...
          fields:[
            ...
            { name:'fraction',    title:'Fraction',     type:'string', options:{ list:['1/2', '1/3', '1/4', '3/4', '2/3'] }},
            { name:'unit',        title:'Unit',         type:'string', options:{ list:['grams', 'cup', 'Tbsp.', 'tsp.'] }}
          ],
          preview: {
            select: {
            ...
            prepare({
              ...
              subtitle,
              media,
              wholeNumber = '(No whole umber set)',
              fraction = '(No fraction set)',
              unit = '(No unit set)',
            }){
              return { title, subtitle:`${wholeNumber} ${fraction} ${unit}`, media };
            },
          },
        },
      ],
